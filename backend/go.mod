module github.com/CZnavody19/music-manager

go 1.24.2

replace go.uber.org/zap => github.com/ziyaozclk/zap v1.19.3-0.20211130062134-0e5b37a8cfa6
...
require (
	...
	go.uploadedlobster.com/musicbrainzws2 v0.17.0
...
require (
	...
	github.com/LukeHagar/plexgo v0.26.1 // indirect
